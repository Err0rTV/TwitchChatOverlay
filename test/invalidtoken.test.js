...
describe.each([
	['--chatbox-testMode: 1;', "--chatbox-token: oauth:333;",["invalid token, please provide a valid token",]],
	['--chatbox-testMode: 2;', "--chatbox-token: oauth:333;",["invalid token, please provide a valid token",]],
